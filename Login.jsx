  ...
  return (
    <div  >
      ...
      <div className='flex items-center justify-center max-w-5xl mx-auto'>
        <form onSubmit={submitHandler} className='w-1/2 border border-gray-200 rounded-md p-4 my-10 bg'>
          ...
          <span className='justify-center'>Don't have an account? <Link to="/signup" className='text-blue-600 '>Register</Link></span>
        </form>
      </div>
    </div>
  )
